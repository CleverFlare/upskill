...
const createCourseSchema = zod_1.z.object({
    ...
    thumbnail: zod_1.z.instanceof(Blob, { message: "The thumbnail is required" }),
    banner: zod_1.z.instanceof(Blob, { message: "The banner is required" }),
    description: zod_1.z
...
exports.default = createCourseSchema;
